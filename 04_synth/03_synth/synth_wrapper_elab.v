...
// Generated on: May 24 2025 16:37:10
...
module d_flipflop(clk, rstn, d, q);
  ...
  bmux mux_q_8_8(.ctl (n_2), .in_0 (d), .in_1 (1'b0), .z (UNCONNECTED));
  not g1 (n_2, rstn);
...
module bmux_1_3(ctl, in_0, in_1, z);
  input ctl;
  input [2:0] in_0, in_1;
  output [2:0] z;
  wire ctl;
...
module bmux_2_4(ctl, in_0, in_1, z);
  input ctl;
  input [7:0] in_0, in_1;
  output [7:0] z;
  wire ctl;
...
module synth_wrapper(clk, rst_n, A, B, op_sel, result, carry);
  ...
  wire UNCONNECTED24, UNCONNECTED25, UNCONNECTED26, UNCONNECTED27,
       carry_reg_84, n_29, \result_reg[0]_60 , \result_reg[1]_61 ;
  wire \result_reg[2]_62 , \result_reg[3]_63 , \result_reg[4]_64 ,
       \result_reg[5]_65 , \result_reg[6]_66 , \result_reg[7]_67 ;
  ...
  bmux_1_3 mux_op_sel_reg_18_7(.ctl (n_29), .in_0 (op_sel), .in_1
       (3'b000), .z ({UNCONNECTED2, UNCONNECTED1, UNCONNECTED0}));
  bmux_2_4 mux_B_reg_18_7(.ctl (n_29), .in_0 (B), .in_1 (8'b00000000),
       .z ({UNCONNECTED10, UNCONNECTED9, UNCONNECTED8, UNCONNECTED7,
       UNCONNECTED6, UNCONNECTED5, UNCONNECTED4, UNCONNECTED3}));
  bmux_2_4 mux_A_reg_18_7(.ctl (n_29), .in_0 (A), .in_1 (8'b00000000),
       .z ({UNCONNECTED18, UNCONNECTED17, UNCONNECTED16, UNCONNECTED15,
       UNCONNECTED14, UNCONNECTED13, UNCONNECTED12, UNCONNECTED11}));
  bmux mux_carry_18_7(.ctl (n_29), .in_0 (carry_reg_84), .in_1 (1'b0),
       .z (UNCONNECTED19));
  bmux_2_4 mux_result_18_7(.ctl (n_29), .in_0 ({\result_reg[7]_67 ,
       \result_reg[6]_66 , \result_reg[5]_65 , \result_reg[4]_64 ,
       \result_reg[3]_63 , \result_reg[2]_62 , \result_reg[1]_61 ,
       \result_reg[0]_60 }), .in_1 (8'b00000000), .z ({UNCONNECTED27,
       UNCONNECTED26, UNCONNECTED25, UNCONNECTED24, UNCONNECTED23,
       UNCONNECTED22, UNCONNECTED21, UNCONNECTED20}));
  not g1 (n_29, rst_n);
