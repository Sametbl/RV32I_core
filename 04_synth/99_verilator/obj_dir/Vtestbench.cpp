...
void Vtestbench___024root__trace_decl_types(VerilatedFst* tracep);
...
VL_ATTR_COLD void Vtestbench::traceBaseModel(VerilatedTraceBaseC* tfp, int levels, int options) {
    ...
    if (VL_UNLIKELY(!stfp)) {
        vl_fatal(__FILE__, __LINE__, __FILE__,"'Vtestbench::trace()' called on non-VerilatedFstC object;"
